...
class DataImunisasiBalita implements FromCollection, WithHeadings, WithStyles, WithColumnFormatting, WithEvents
{
    protected $jadwalId;
    ...
    public function collection()
{
    ...
    $processedData = $data->map(function ($peserta) {
        ...
        return [
            ...
            'imunisasi' => $dataKesehatan ? $dataKesehatan->imunisasi : 'N/A',
        ];
    });
