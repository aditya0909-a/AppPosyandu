...
class DataSusuBalita implements FromCollection, WithHeadings, WithStyles, WithColumnFormatting, WithEvents
{
    protected $jadwalId;
    ...
    public function collection()
{
    ...
    $processedData = $data->map(function ($peserta) {
        ...
        return [
            ...
            'susu' => $dataKesehatan && $dataKesehatan->susu === 'iya' ? 'Sudah Diberikan' : 'Belum Diberikan',
        ];
    });
