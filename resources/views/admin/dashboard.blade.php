...
<section class="container mx-auto py-10 px-4 p-6 sm:p-8">
  ...
  <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <!-- Data Balita -->
    <a href="/fiturdatabalita/admin/{{ $userId }}" class="block button-primary text-white rounded-lg shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
    ...
    <!-- Data Lansia -->
    <a href="/fiturdatalansia/admin/{{ $userId }}" class="block button-primary text-white rounded-lg shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
    ...
    <!-- Penjadwalan -->
    <a href="/fiturpenjadwalan/admin/{{ $userId }}" class="block button-primary text-white rounded-lg shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
    ...
    <!-- Kelola Akun -->
    <a href="/fiturkelolaakun/admin/{{ $userId }}" class="block button-primary text-white rounded-lg shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
