    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
      ...
      <form id="peserta-form">
        <div class="mb-4">
          ...
          <input type="text" id="name" class="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan nama anak">
        </div>
        <div class="mb-4">
          <label for="id" class="block text-sm font-medium text-gray-700">NIK Anak</label>
          <input type="text" id="id" class="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan NIK anak">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
          <label for="type" class="block text-sm font-medium text-gray-700">Nama Orang Tua</label>
          <input type="text" id="type" class="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan nama orang tua">
        </div>
        <div class="mb-4">
          <label for="faskes" class="block text-sm font-medium text-gray-700">NIK Orang Tua</label>
          <input type="text" id="faskes" class="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukan NIK orang tua">
        </div>
        <div class="mb-4">
