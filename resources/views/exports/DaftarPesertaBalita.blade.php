...
<body>
    <h2>Daftar Peserta {{ $jadwal->name }}</h2>
        ...
        <tbody>
            @foreach ($data as $index => $peserta)
                <tr>
                    ...
                    <td>{{ $peserta->TanggalLahir_balita }}</td>
                    <td>{{ $peserta->NIK_balita }}</td>
                    <td>{{ $peserta->nama_orangtua_balita }}</td>
                    <td>{{ $peserta->NIK_orangtua_balita }}</td>
                    <td>{{ $peserta->alamat_balita }}</td>
                    <td>{{ $peserta->wa_balita }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
