...
<nav class="navbar shadow-md p-4 fixed top-0 left-0 right-0 z-10 glass-effect">
    <div class="container mx-auto flex items-center justify-between">
      ...
      <div class="text-[#0077B5] font-sans">Akun Petugas</div>
    </div>
  </nav>
...
<section class="container mx-auto py-10 px-4 p-6 sm:p-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="/fiturjadwal/petugas"
                ...
                <p class="text-sm opacity-75">Jadwal kegiatan posyandu</p>
            </a>
            ...
            <form action="/logout" method="POST">
                ...
                <button class="w-full h-full" type="submit">
                    <div
                        ...
                        <p class="text-sm opacity-75">Keluar dari akun petugas</p>
                    </div>
                </button>
