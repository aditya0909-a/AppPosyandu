...
<script>
    ...
    function appData() {
        return {
            ...
            openEditModal(id, imunisasi) {
                this.editData = { id, imunisasi: imunisasi,};
            ...
            updatePesertaList() {
                ...
                const imunisasiA = dataKesehatanA ? dataKesehatanA.imunisasi : null;
                const imunisasiB = dataKesehatanB ? dataKesehatanB.imunisasi : null;

                // Jika imunisasiA = null, letakkan di atas
                if (imunisasiA === null && imunisasiB !== null) return -1;
                if (imunisasiB === null && imunisasiA !== null) return 1;
                ...
                sortedPeserta.forEach(item => {
                    ...
                    card.classList.add(dataKesehatan && dataKesehatan.imunisasi === null ? 'bg-white':'bg-gray-200' );
                    ...
                    const imunisasiText = document.createElement('p');
                    imunisasiText.classList.add('text-sm', 'text-gray-600', 'mb-2');
                    imunisasiText.textContent = dataKesehatan && dataKesehatan.imunisasi === null
                    ? 'Belum diberikan imunisasi'
                    : `Sudah diberikan imunisasi ${dataKesehatan.imunisasi}`;
                    contentLeft.appendChild(imunisasiText);
                    ...
                    if (dataKesehatan) {
                        ...
                        button.addEventListener('click', () => {
                            ...
                            this.openEditModal(dataKesehatan.id, dataKesehatan.imunisasi );
                        });
